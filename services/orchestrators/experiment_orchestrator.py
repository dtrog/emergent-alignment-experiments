...
from models.manipulations import ManipulationAttempt, PersuasionOutcome
from models.prompts import Prompt


if TYPE_CHECKING:
    from prompt_builders.prompt_builders import (
...
from prompt_builders.prompt_builders import JudgePromptBuilder, PersuasionPromptBuilder
...
class ExperimentOrchestrator:
    ...
    def _conduct_persuasion_phase(
        ...
        for tactic_config in self.persuasion_tactics[:-1]:  # Exclude the improvised slot
            ...
            from models.manipulations import PersuasionAttempt  # Late import to avoid circular dependency
    ...
    def _conduct_manipulation_attempt(
        ...
        from models.manipulations import ManipulationAttempt  # Late import to avoid circular dependency
...
class CommitteeService:
    ...
    def analyze_persuasion_attempt(
        ...
        """
        from models.manipulations import PersuasionAttempt, PersuasionOutcome  # Late import to avoid circular dependency
    ...
    def _parse_committee_analysis(self, synthesis: str) -> Dict[str, Any]:
        ...
        """
        from models.analysis import EthicalAbort, PersonaAlignment, CASVector  # Late import to avoid circular dependency
