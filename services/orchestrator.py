...
from services.experiment_orchestrator import CommitteeService
...
if TYPE_CHECKING:
    ...
    from models import SubjectLLM, JudgeLLM, ManipulatorLLM, JudgesCommittee, ChairJudgeLLM
    from models import StewardshipMemo, EthicalResilienceMemo
    from models import Prompt
    from models import ExperimentSession, CommitteeStewardshipMemo, EthicalResilienceMemo
    from models import PersuasionAttempt, ManipulationAttempt, PersuasionOutcome
    from models import EthicalAbort, PersonaAlignment, CASVector
    from enums import PersuasionOutcome as PersuasionOutcomeEnum
...
class ExperimentOrchestrator:
    ...
    def _conduct_persuasion_phase(
        ...
        for tactic_config in self.persuasion_tactics[:-1]:  # Exclude the improvised slot
            from prompt_builders.prompt_builders import PersuasionPromptBuilder
            ...
            from models import PersuasionAttempt  # Late import to avoid circular dependency
...
class CommitteeService:
    ...
    def analyze_initial_response(self, prompt: str, response: str) -> 'CommitteeStewardshipMemo':
        """
        ...
        from models.memos import CommitteeStewardshipMemo
        return CommitteeStewardshipMemo(
    ...
    def analyze_persuasion_attempt(
        ...
        """
        from enums import PersuasionOutcome
        from models import PersuasionAttempt
        ...
        analyses = []
        for judge in self.judges:
            from prompt_builders.prompt_builders import JudgePromptBuilder
    ...
    def _parse_committee_analysis(self, synthesis: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'persona_alignment_analysis': None,
            'cas_vector': None
        }